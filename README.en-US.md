...
<p align="center">
  <b>Live Demo and Public Credentials</b>&nbsp;&nbsp;<a href="./README.md">See the Chinese project homepage</a><br/><br/>
...
For local development, set `apiBaseUrl` to your own compatible backend. The Chinese project homepage also documents the hosted read-only demonstration environment.
